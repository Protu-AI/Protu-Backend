...
public class AdminController {
  ...
  public ResponseEntity<ApiResponse<DeactivateResDto>> deactivateUser(
    ...
    return buildResponse(properties.getVersion(), request, HttpStatus.OK, responseDto, SuccessMessages.DEACTIVATE_USER_MSG.message);
  }
  ...
  public ResponseEntity<ApiResponse<Void>> activateUser(
    ...
    return buildResponse(properties.getVersion(), request, HttpStatus.OK, null, SuccessMessages.ACTIVATE_USER_MSG.message);
  }
  ...
  public ResponseEntity<ApiResponse<UserDetailsForAdminDto>> getUserDetailsForAdmin(
    ...
    return buildResponse(properties.getVersion(), request, HttpStatus.OK, userDetails, SuccessMessages.GET_USER_MSG.message);
  }
  ...
  public ResponseEntity<ApiResponse<UserDetailsForAdminDto>> addRoleToUser(
    ...
    return buildResponse(properties.getVersion(), request, HttpStatus.OK, userDetails, SuccessMessages.NEW_ROLE_FOR_USER.message);
  }
